        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="{{ route('artikel') }}"
                    class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group {{ Request::is('artikel') ? 'bg-gray-500 dark:bg-gray-700' : '' }}">
            ...
            <li>
                <a href="{{ route('tanggapan') }}"
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Tanggapan</span>
                </a>
            </li>
            <li>
            ...
            <li>
                <button type="button"
                    ...
                    <span class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">Penduduk</span>
                ...
                <ul id="dropdown-example" class="hidden py-2 space-y-2">
                    <li>
                        <a href="#"
                            class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Rumah
                            Tangga</a>
                    </li>
                </ul>
            </li>
            ...
            <li>
                <a href="{{ route('pemetaan') }}"
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Pemetaan</span>
                </a>
            </li>
            <li>
                <a href="#"
