        ...
        <div class="p-4 sm:ml-64">
            <div class="flex flex-col">
                ...
                <div class="flex justify-between items-center mb-2">
                    <div class="p-3 mb-0 text-sm text-blue-800 rounded-lg lg:w-1/2 bg-blue-50 dark:bg-gray-800 dark:text-blue-400"
                        ...
                        <span class="font-medium">Dashboard</span> > Tanggapan > Administrator / Staff
                    </div>
            ...
            <div class="relative overflow-x-auto mt-4 px-4">
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    @include('admin.components.modals.tanggapan.tambahdata')
                    <thead
                    ...
                    <tbody>
                        ...
                        @include('admin.components.modals.tanggapan.editdata')
                    </tbody>
                </table>
            </div>
            {{-- delete --}}
